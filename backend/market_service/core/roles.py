...
Deliberately duplicated rather than imported. Services in this repository share
no code and no schema, and a package that both import would be the first thread
tying them together. The coupling that exists is the `role` claim in the access
